...
//todo: закончил на стилях карты
function MainMap({ showModal, showSideBar, qrCodes, images }) {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ height: 180 }} className={cn("box")}>
        <FormControlLabel
          control={
            <Fab
              style={{
